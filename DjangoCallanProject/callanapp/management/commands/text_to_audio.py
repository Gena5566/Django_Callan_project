...
class Command(BaseCommand):
    help = 'Convert text to audio and provide the audio file path'
    ...
    def handle(self, *args, **options):
        ...
        if form_data.is_valid():
            ...
            stripped_audio = detect_nonsilent(audio, silence_thresh=-50, min_silence_len=120)
            ...
            new_output_path = os.path.join("media", "speed_changed.mp3")
            change_audio_speed(output_audio_path, new_output_path, speed_factor)

            # Print the path to the audio file
            print(f"Audio file path: {new_output_path}")
            ...
            os.remove('speed_changed.mp3')

            print("Временные папки и данные очищены")
